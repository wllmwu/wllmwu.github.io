...
<ShowcaseGrid>
  <Showcase
    title="Copy Better"
    description="A convenient clipboard extension app for storing and organizing clips to paste anywhere, with 17,000+ downloads on the App Store! Built with Swift and Xcode."
