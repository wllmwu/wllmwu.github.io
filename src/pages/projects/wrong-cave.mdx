...
- **[cannon-es](https://pmndrs.github.io/cannon-es/docs/index.html):** Physics
  ...
  - I think that ultimately, we still saved time by using the library instead of
    rolling our own physics, but it would have been a cool experience to write a
    custom physics engine too.
...
- **Week 7:** Support for multiple players; throwing items; recipe crafting
  ...
  - I think that early on, we didn't know enough about the tools and game
    elements yet to properly plan out our requirements, so having this
    experience seems helpful for avoiding that kind of situation in the future.
